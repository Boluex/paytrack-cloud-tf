...
############################################
# IAM: Task Execution Role (pulls image, writes logs, reads secrets)
############################################
...
############################################
# IAM: Task Role (permissions the app itself needs at runtime)
############################################
...
resource "aws_ecs_service" "this" {
  ...
  lifecycle {
    ignore_changes = [desired_count] # let autoscaling own this after first apply
  }
